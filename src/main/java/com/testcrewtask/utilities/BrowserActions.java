...
public class BrowserActions {
    ...
    public static void waitUntilWebElementIsVisible(By element, WebDriver driver){
    ...
    public static void waitUntilWebElementIsNotVisible(By element,WebDriver driver){
        WebDriverWait wait=new WebDriverWait(driver, timeOut);
        try{
